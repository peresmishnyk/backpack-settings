...
namespace Peresmishnyk\BackpackSetting\Http\Controllers;

use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Illuminate\Support\Facades\Route;
use Peresmishnyk\BackpackSetting\Models\SettingModel;
...
class SettingController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/setting/' . $this->segment);
...
//        dump('setup routes');
    ...
    {
        Route::get('setting/' . $segment, [
            'as' => $routeName . '.edit',
            'uses' => $controller . '@edit',
            'operation' => 'update',
        ]);

        Route::put('setting/' . $segment, [
            'as' => $routeName . '.update',
...
//        $this->crud->setOperationSetting('fields', $this->crud->getUpdateFields());
        ...
        $entry = $model->firstOrCreate([$model->getKeyName() => $this->segment]);
