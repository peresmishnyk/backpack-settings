...
class SettingsControllerBackpackCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack Settings controller';
    ...
    {
        return __DIR__.'/../stubs/settings-controller.php';
    }
